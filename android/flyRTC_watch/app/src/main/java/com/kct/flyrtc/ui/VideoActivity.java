...
import com.kct.flyrtc.call.CallFragmentActivity;
...
public class VideoActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        encParam.usWidth = 172;   // 推荐使用240x320，或者360x480
        encParam.usHeight = 320;
        encParam.ucUseHwEnc = 0;   // 硬编码
        encParam.ucUseHwDec = 0;   // 硬解码
        encParam.usMinBitrate = 50;
        encParam.usMaxBitrate = 150;
        encParam.ucmaxFramerate = 8;
        encParam.usStartBitrate = 150;
        encParam.bitrates[1][0] = 550;  // the bitrate threshold for 240x320 to 360x480
    ...
    protected void onResume() {
        KCSdk.getInstance().SwitchVideo(0, KCBase.RotateType.RETATE_270);
    ...
    class VideoAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (null == convertView) {
                ...
                viewHolder.video_list_iv = convertView.findViewById(R.id.common_list_image);
            ...
            viewHolder.video_list_bt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (((MainApplication)getApplication()).bConnect) {
                        Intent mIntent = new Intent(VideoActivity.this, CallFragmentActivity.class);
