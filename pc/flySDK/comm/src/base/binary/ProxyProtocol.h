...
struct ProxyProtocol {
	...
	enum {
       ...
       RESP_REG        			= 10600001,		/**< Reg 响应 */
		...
		REQ_AUTH					= 600002,		/**< Auth 请求 */
		RESP_AUTH       			= 10600002,  	/**< Auth 响应 */
		REQ_REAUTH       			= 600003,		/**< ReAuth请求 使用SK */
		RESP_REAUTH       			= 10600003,		/**< ReAuth响应 使用SK */

		REQ_INIT					= 600010,		/**< Init 请求 */
    	RESP_INIT					= 10600010,
		REQ_NEW_SYNC        		= 600011,		/**< New Sync 请求 */
		RESP_NEW_SYNC       		= 10600011,		/**< New Sync 响应 */
		REQ_SEND_MSG    			= 600012,		/**< SendMsg 请求 */
		RESP_SEND_MSG   			= 10600012,		/**< SendMsg 响应 */
		...
		REQ_NEW_SYNCCHK 			= 600017,      /**< NewSyncCheck 请求 */
		RESP_NEW_SYNCCHK			= 10600017,		/**< NewSyncCheck 请求 */
		...
		REQ_UPLOAD_VIDEO     		= 600037,      /**< UploadVideo 请求 */
		RESP_UPLOAD_VIDEO    		= 10600037,		/**< UploadVideo 响应 */
		REQ_DOWNLOAD_VIDEO     		= 600038,      /**< DownloadVideo 请求 */
		RESP_DOWNLOAD_VIDEO    		= 10600038,		/**< DownloadVideo 响应 */
		...
		REQ_CREATE_GROUP			= 600090,		/**< CreateGroup 请求*/
		RESP_CREATE_GROUP			= 10600090,		/**< CreateGroup 响应*/

		REQ_ADD_GROUP_MEMBER		= 600091,		/**< AddGroupMember 请求*/
		RESP_ADD_GROUP_MEMBER		= 10600091,		/**< AddGroupMember 响应*/

		REQ_DEL_GROUP_MEMBER		= 600092,		/**< DelGroupMember 请求*/
		RESP_DEL_GROUP_MEMBER		= 10600092,		/**< DelGroupMember 响应*/
		
		REQ_QUIT_GROUP				= 600093,		/**< QuitGroup 请求*/
		RESP_QUIT_GROUP				= 10600093,		/**< QuitGroup 响应*/
		//==========================群相关结束==================
