...
#import "UCSKeyboradViewController.h"
#import "Contact.h"
#import "UCSVOIPViewEngine.h"

@interface UCSKeyboradViewController ()
...
@implementation UCSKeyboradViewController
...
- (void)callButtonClick{
    ...
    [[UCSVOIPViewEngine getInstance] makingCallViewCallNumber:self.numberLabel.text callType:1 callName:self.numberLabel.text];
    
}

- (void)hideKeyboardView{
    
    [[UCSVOIPViewEngine getInstance] releaseKeyboardViewAnimation:YES];
