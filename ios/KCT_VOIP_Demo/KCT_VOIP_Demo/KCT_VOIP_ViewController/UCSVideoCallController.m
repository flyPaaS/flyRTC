...
@interface UCSVideoCallController ()
...
- (void)makeVideoCallView{
    ...
    self.videoLocationView = [[UCSFuncEngine getInstance] allocCameraViewWithFrame:CGRectMake(Adaptation(220), Adaptation(220), Adaptation(90), Adaptation(120))];
...
- (void)viewDidLoad
{
    ...
    */
    ...
    /**
     ...
     初始化视频界面
     */
    [[UCSFuncEngine getInstance] initCameraConfig:self.videoLocationView withRemoteVideoView:self.videoRemoteView];
...
- (void)rotationCameraAngle:(unsigned int)rotationAngle{
    ...
    [[UCSFuncEngine getInstance] setRotationVideo:rotationAngle withReciviedRotation:rotationAngle];
