//
//  UIScrollView+KCkeyboardControl.m
//  KCT_VOIP_Demo_1.0
//
...
#import "UIScrollView+KCkeyboardControl.h"
...
@interface UIScrollView (UCKetboradControl)

@property (nonatomic, assign) CGFloat previousKeyboardY;

@end

@implementation UIScrollView (KCkeyboardControl)
