...
// This is a helper class used by UCSASIHTTPRequest to handle inflating (decompressing) data in memory and on disk
...
@interface UCSASIDataDecompressor : NSObject {
	BOOL streamReady;
	z_stream zStream;
}
