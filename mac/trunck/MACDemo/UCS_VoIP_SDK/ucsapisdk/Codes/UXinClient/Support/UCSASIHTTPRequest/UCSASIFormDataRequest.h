...
#import "UCSASIHTTPRequestConfig.h"
...
@interface UCSASIFormDataRequest : UCSASIHTTPRequest <NSCopying> {
	...
	// Will store a string version of the request body that will be printed to the console when UCSASIHTTPRequest_DEBUG is set in GCC_PREPROCESSOR_DEFINITIONS
