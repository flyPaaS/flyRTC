...
#import "UCSASIHTTPRequestDelegate.h"
#import "UCSASIProgressDelegate.h"

@interface UCSASINetworkQueue : NSOperationQueue <UCSASIProgressDelegate, UCSASIHTTPRequestDelegate, NSCopying> {
...
// All UCSASINetworkQueues are paused when created so that total size can be calculated before the queue starts
