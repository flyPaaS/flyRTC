...
// Private stuff
@interface UCSASIFormDataRequest ()
...
@implementation UCSASIFormDataRequest
...
- (void)addFile:(NSString *)filePath withFileName:(NSString *)fileName andContentType:(NSString *)contentType forKey:(NSString *)key
{
	...
	if (!fileExists || isDirectory) {
		[self failWithError:[NSError errorWithDomain:UCSVoipNetworkRequestErrorDomain code:ASIInternalErrorWhileBuildingRequestType userInfo:[NSDictionary dictionaryWithObjectsAndKeys:[NSString stringWithFormat:@"No file exists at %@",filePath],NSLocalizedDescriptionKey,nil]]];
	}
	...
	if (!contentType) {
		contentType = [UCSASIHTTPRequest mimeTypeForFileAtPath:filePath];
	}
...
{
	UCSASIFormDataRequest *newRequest = [super copyWithZone:zone];
