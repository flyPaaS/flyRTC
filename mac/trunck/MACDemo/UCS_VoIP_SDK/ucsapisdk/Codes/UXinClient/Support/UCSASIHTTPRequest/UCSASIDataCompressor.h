...
// This is a helper class used by UCSASIHTTPRequest to handle deflating (compressing) data in memory and on disk
...
@interface UCSASIDataCompressor : NSObject {
	BOOL streamReady;
	z_stream zStream;
}
