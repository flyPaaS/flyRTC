...
typedef enum _ASICachePolicy {
	...
	// UCSASIDownloadCache's default cache policy is 'ASIAskServerIfModifiedWhenStaleCachePolicy'
...
// Calling [UCSASIHTTPRequest clearSession] will remove any data stored using ASICacheForSessionDurationCacheStoragePolicy
...
@protocol UCSASICacheDelegate <NSObject>
