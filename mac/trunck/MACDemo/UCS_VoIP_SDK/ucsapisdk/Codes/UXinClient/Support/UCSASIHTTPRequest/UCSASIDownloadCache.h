...
#import "UCSASICacheDelegate.h"

@interface UCSASIDownloadCache : NSObject <UCSASICacheDelegate> {
	...
	// Defaults to a directory called 'UCSASIHTTPRequestCache' in the temporary directory
...
// Returns a static instance of an UCSASIDownloadCache
// In most circumstances, it will make sense to use this as a global cache, rather than creating your own cache
// To make UCSASIHTTPRequests use it automatically, use [UCSASIHTTPRequest setDefaultCache:[UCSASIDownloadCache sharedCache]];
+ (id)sharedCache;
