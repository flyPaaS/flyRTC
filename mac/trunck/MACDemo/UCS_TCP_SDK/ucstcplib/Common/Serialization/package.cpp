...
//		hexdump((const void*) pkg.GetBody()->GetBuffer() , pkg.GetBody()->GetLen()  ) ;
	...
	*/
	bool compress(UCSPkg& pkg) {
		...
		{
			//设置压缩算法
			head->CompressVersion = UCSCOMPRESS_PACK_VERSION_1;
			head->CompressAlgorithm = UcsMsg::UCSCPR_ZLIB_COMPRESS;
			head->CompressLen = body->GetLen();

			//压缩
			RBBuffer comBuf;
			ret = UcsMsg::Compress((unsigned char*)body->GetBuffer(), body->GetLen(),
...
//			cout << "DESDecrypt OK!!!" << ret << endl;
		...
		if (UcsMsg::UCSCPR_NO_COMPRESS == head->CompressAlgorithm)
		{
			return true;
		}
		...
		//解压缩
		RBBuffer decomBuf;
		ret = UcsMsg::Decompress((unsigned char*)body->GetBuffer(), body->GetLen(),&decomBuf,
...
protected:
	...
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_ReAuth,bodyHead, bodyData);
	}
...
protected:
	...
	*/
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_Auth, bodyHead, bodyData);
	}
...
protected:
	...
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_Reg, bodyHead, bodyData);
	}
...
protected:
	...
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_GetHDHeadImg, bodyHead, bodyData);
	}
...
protected:
	...
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_UploadHDHeadImg, bodyHead, bodyData);
	}
...
protected:
	...
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_UploadMsgImg, bodyHead, bodyData);
	}
...
protected:
	...
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_DownloadMsgImg, bodyHead, bodyData);
	}
...
protected:
	...
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_UploadVideo, bodyHead, bodyData);
	}
...
protected:
	...
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_DownloadVideo, bodyHead, bodyData);
	}
...
protected:
	...
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_UploadVoice, bodyHead, bodyData);
	}
...
protected:
	...
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_DownloadVoice, bodyHead, bodyData);
	}
...
protected:
	...
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_SendMsg, bodyHead, bodyData);
	}
...
protected:
	...
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_NewSync, bodyHead, bodyData);
	}
...
protected:
	...
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_CreateGroup, bodyHead, bodyData);
	}
...
protected:
	...
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_AddGroupMember, bodyHead, bodyData);
	}
...
protected:
	...
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_DelGroupMember, bodyHead, bodyData);
	}
...
protected:
	...
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_QuitGroup, bodyHead, bodyData);
	}
...
protected:
	...
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_CreateChatRoom, bodyHead, bodyData);
	}
...
protected:
	...
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_AddChatRoomMember, bodyHead, bodyData);
	}
...
protected:
	...
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_DelChatRoomMember, bodyHead, bodyData);
	}
...
protected:
	...
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_QuitChatRoom, bodyHead, bodyData);
	}
...
protected:
	...
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_NewInit, bodyHead, bodyData);
	}
...
protected:
	...
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_SyncFriend, bodyHead, bodyData);
	}
...
protected:
	...
	virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
		...
		return createMMPackage(UCSFunc_GetContact, bodyHead, bodyData);
	}
...
protected:
    ...
    virtual bool createPackage(BodyHead_t* bodyHead, void* bodyData) {
        ...
        return createMMPackage(UCSFunc_PushSet, bodyHead, bodyData);
    }
