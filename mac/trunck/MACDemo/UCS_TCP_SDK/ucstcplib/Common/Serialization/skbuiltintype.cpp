...
static const SKMetaField_t g_tMetaSKBuiltinInt32 [] = {
	{ "Val", static_cast<short>SK_FIELD_OFFSET(SKBuiltinInt32_t, iVal), eTypeSKInt32, 0, 1, -1,
		"", 1, sizeof(int), sizeof(int), 1, 0 }
};

static const SKMetaField_t g_tMetaSKBuiltinUint32 [] = {
	{ "Val", static_cast<short>SK_FIELD_OFFSET(SKBuiltinUint32_t, iVal), eTypeSKUint32, 0, 1, -1,
		"", 1, sizeof(unsigned int), sizeof(unsigned int), 1, 0 }
};

static const SKMetaField_t g_tMetaSKBuiltinChar [] = {
	{ "Val", static_cast<short>SK_FIELD_OFFSET(SKBuiltinChar_t, cVal), eTypeSKChar, 0, 1, -1,
		"", 1, sizeof(char), sizeof(char), 1, 0 }
};

static const SKMetaField_t g_tMetaSKBuiltinUchar [] = {
	{ "Val", static_cast<short>SK_FIELD_OFFSET(SKBuiltinUchar_t, cVal), eTypeSKUchar, 0, 1, -1,
		"", 1, sizeof(unsigned char), sizeof(unsigned char), 1, 0 }
};

static const SKMetaField_t g_tMetaSKBuiltinInt8 [] = {
	{ "Val", static_cast<short>SK_FIELD_OFFSET(SKBuiltinInt8_t, cVal), eTypeSKChar, 0, 1, -1,
		"", 1, sizeof(char), sizeof(char), 1, 0 }
};

static const SKMetaField_t g_tMetaSKBuiltinUint8 [] = {
	{ "Val", static_cast<short>SK_FIELD_OFFSET(SKBuiltinUint8_t, cVal), eTypeSKUchar, 0, 1, -1,
		"", 1, sizeof(unsigned char), sizeof(unsigned char), 1, 0 }
};

static const SKMetaField_t g_tMetaSKBuiltinInt16 [] = {
	{ "Val", static_cast<short>SK_FIELD_OFFSET(SKBuiltinInt16_t, hVal), eTypeSKInt16, 0, 1, -1,
		"", 1, sizeof(short), sizeof(short), 1, 0 }
};

static const SKMetaField_t g_tMetaSKBuiltinUint16 [] = {
	{ "Val", static_cast<short>SK_FIELD_OFFSET(SKBuiltinUint16_t, hVal), eTypeSKUint16, 0, 1, -1,
		"", 1, sizeof(unsigned short), sizeof(unsigned short), 1, 0 }
};

static const SKMetaField_t g_tMetaSKBuiltinInt64 [] = {
	{ "Val", static_cast<short>SK_FIELD_OFFSET(SKBuiltinInt64_t, llVal), eTypeSKInt64, 0, 1, -1,
		"", 1, sizeof(long long), sizeof(long long), 1, 0 }
};

static const SKMetaField_t g_tMetaSKBuiltinUint64 [] = {
	{ "Val", static_cast<short>SK_FIELD_OFFSET(SKBuiltinUint64_t, llVal), eTypeSKUint64, 0, 1, -1,
		"", 1, sizeof(unsigned long long), sizeof(unsigned long long), 1, 0 }
};

static const SKMetaField_t g_tMetaSKBuiltinFloat32 [] = {
	{ "Val", static_cast<short>SK_FIELD_OFFSET(SKBuiltinFloat32_t, fVal), eTypeSKFloat32, 0, 1, -1,
		"", 1, sizeof(float), sizeof(float), 1, 0 }
};

static const SKMetaField_t g_tMetaSKBuiltinDouble64 [] = {
	{ "Val", static_cast<short>SK_FIELD_OFFSET(SKBuiltinDouble64_t, dVal), eTypeSKDouble64, 0, 1, -1,
		"", 1, sizeof(double), sizeof(double), 1, 0 }
};

static const SKMetaField_t g_tMetaQSUint [] = {
	{ "Val", static_cast<short>SK_FIELD_OFFSET(qs_uin_t, uin), eTypeSKUint32, 0, 1, -1,
		"", 1, sizeof(unsigned int), sizeof(unsigned int), 1, 0 }
};
...
static const SKMetaField_t g_tMetaSKBuiltinBuffer [] = {
	{ "Len", static_cast<short>SK_FIELD_OFFSET(SKBuiltinBuffer_t, iLen), eTypeSKInt32, 0, 1, -1,
		"", 1, sizeof(int), sizeof(int), 1, 0 },
	{ "Buff", static_cast<short>SK_FIELD_OFFSET(SKBuiltinBuffer_t, pcBuff), eTypeSKChar, 1, 0, -1,
		"Len", 2, sizeof(char *), sizeof(char), 1, 0 }
};

static const SKMetaField_t g_tMetaSKBuiltinString [] = {
	{ "Buff", static_cast<short>SK_FIELD_OFFSET(SKBuiltinString_t, pcBuff), eTypeSKChar, 1, 0, -1,
